...
class TapJoyPlugin {
  ...
  Future<void> setSubjectToGDPR(bool subjectToGDPR) async {
    await _channel.invokeListMethod(
        "setSubjectToGDPR", <String, dynamic>{'subjectToGDPR': subjectToGDPR});
  }

  Future<void> setUserConsent(String userConsent) async {
    await _channel.invokeMethod(
        'setUserConsent', <String, dynamic>{'userConsent': userConsent});
  }

  Future<void> setBelowConsentAge(bool belowConsentAge) async {
    await _channel.invokeListMethod('setBelowConsentAge',
        <String, dynamic>{'belowConsentAge': belowConsentAge});
  }

  Future<void> setUSPrivacy(String usPrivacy) async {
    await _channel.invokeMethod(
        'setUsPrivacy', <String, dynamic>{'usPrivacy': usPrivacy});
  }

  Future<void> setPushNotificationDisabled(bool disabled) async {
    await _channel.invokeMethod(
        'setPushNotificationDisabled', <String, dynamic>{'disabled': disabled});
  }
  ...
  Future<void> _handleMethod(MethodCall call) async {
    switch (call.method) {
      ...
      case 'connectionFail':
        ...
        break;
      case 'requestSuccess':
        String? placementName = call.arguments["placementName"] as String?;
      ...
      case 'onGetCurrencyBalanceResponse':
        int? balance = call.arguments["balance"] as int?;
        String? currencyName = call.arguments["currencyName"] as String?;
        String? error = call.arguments["error"] as String?;
      ...
      case 'onEarnedCurrency':
        int? earnedAmount = call.arguments["earnedAmount"] as int?;
        String? currencyName = call.arguments["currencyName"] as String?;
        String? error = call.arguments["error"] as String?;
