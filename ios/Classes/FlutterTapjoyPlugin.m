...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
  ...
  if ([@"connectTapJoy" isEqualToString:call.method]) {
      ...
      NSDictionary *connectFlags = @{TJC_OPTION_USER_ID:userId, TJC_OPTION_ENABLE_LOGGING:[NSNumber numberWithBool:methodDebug.boolValue]};//methodDebug.boolValue};
      [Tapjoy connect:apiKey options:connectFlags];
      ...
      NSLog(@"setSubjectToGDPR");
      TJPrivacyPolicy *privacyPolicy = [Tapjoy getPrivacyPolicy];
      BOOL gdpr = dict[@"subjectToGDPR"];
